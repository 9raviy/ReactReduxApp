...
Frontend Server
Install all project dependencies with npm install start the development server with npm start. Open the localhost:3000 to view the App in development mode on the local server.
